  ...
  return (
    <div style={{position:'fixed',bottom:0,left:0,right:0,background:'#F7F3EE',borderTop:'1px solid #DDD6CC',display:'flex',justifyContent:'space-around',padding:'10px 0 20px'}}>
      ...
      <button onClick={() => window.location.href='/people'} style={{display:'flex',flexDirection:'column',alignItems:'center',gap:'3px',background:'none',border:'none',cursor:'pointer',padding:'4px 10px'}}>
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active==='people'?'#3D2B4F':'#9A928A'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>
        <span style={{fontSize:'10px',color:active==='people'?'#3D2B4F':'#9A928A'}}>People</span>
      </button>
